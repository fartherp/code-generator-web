...
<div id="toolbar">
    <form id="queryForm" class="easyui-form">
        <div>
            类路径<input class="easyui-textbox" type="text" name="classpath" id="classpath" data-options="required:true,prompt:'com.github.fartherp'" value="com.github.fartherp"/>
            项目名<input class="easyui-textbox" type="text" name="projectName" id="projectName" data-options="required:true,prompt:'code'" value="code"/>
        ...
        <div>
            用户名<input class="easyui-textbox" type="text" name="user" id="user" data-options="required:true,prompt:'root'" value="root"/>
            密&nbsp;&nbsp;&nbsp;码<input class="easyui-textbox" type="text" name="password" id="password" data-options="required:true,prompt:'root'" value="root"/>
